...
<div class="topbar">
	...
	<div class="topbar-left">
		<div class="text-center">
			<a href="#" class="logo"><i class="mdi mdi-radar"></i> <span>Sistema Tursi</span></a>
						...
						<li>
							...
							<li class="has_sub">
								...
								<!--<li>
									...
									<li class="has_sub">
										<a href="javascript:void(0);" class="waves-effect waves-primary"><i class="ti-star"></i><span> Alquiler
										</span> <span class="menu-arrow"></span></a>
										<ul class="list-unstyled">
											<li><a href="../html/new_alquiler.php">Nuevo Alquiler</a></li>
											<li><a href="../html/bitacora_alquileres.php">Listado de Alquileres</a></li>
											<!--<li><a href="../html/caja.php">Caja</a></li>-->
										</ul>
									</li>
										...
										<a href="javascript:void(0);" class="waves-effect waves-primary"><i class="ti-agenda"></i><span> Cobros y Pagos </span>
												...
												<ul class="list-unstyled">
													...
													<li><a href="../html/egresos.php">Gastos</a></li>
