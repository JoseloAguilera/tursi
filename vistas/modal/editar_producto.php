								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="mod_precio" name="mod_precio" autocomplete="off" pattern="^[0-9]{1,100}?$" title="Ingresa sólo números enteros" maxlength="100" onkeyup="utilidad_edit();">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
									...
									<!--div class="col-md-4">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="mod_precioe" name="mod_precioe" autocomplete="off" pattern="^[0-9]{1,100}?$" title="Ingresa sólo números con 0 ó 2 decimales" maxlength="100">
										</div>
									</div-->
								</div>
