...
//Cmprobamos si agregamos un producto a la tabla tmp_compra
    ...
    if ($row = mysqli_fetch_array($comprobar)) {
        ...
        $sql          = "UPDATE tmp_compra SET cantidad_tmp='" . $cant . "', costo_tmp='" . $precio_venta . "' WHERE id_producto='" . $id . "' and session_id='" . $session_id . "'";
        $query_update = mysqli_query($conexion, $sql);

    } else {

        $insert_tmp = mysqli_query($conexion, "INSERT INTO tmp_compra (id_producto,cantidad_tmp,costo_tmp,session_id) VALUES ('$id','$cantidad','$precio_venta','$session_id')");
    }
